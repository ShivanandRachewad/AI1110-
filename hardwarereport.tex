...
\begin{document}
	...
	%\setlist[enumerate,1]{before=\renewcommand\theequation{\theenumi.\arabic{equation}}
		...
		\author{ Name -: Shivanand Rachewad
			
			Roll no -: BT22BTECH11014
		% <-this % stops a space
...
\begin{enumerate}
	...
	\item The next connection is XOR gate (7486 IC)  
	 \begin{figure}[h]
	 	\includegraphics[width=\linewidth]{/Users/shivanandrachewad/Desktop/X-OR}
	...
	\begin{figure}[h]
		\includegraphics[width=\linewidth]{/Users/shivanandrachewad/Desktop/7447_table}
		\caption{Connection of seven segmented display with decoder}
		\label{table}
	\end{figure}
	\begin{figure}[h]
		\includegraphics[width=\linewidth]{/Users/shivanandrachewad/Desktop/sevensegment}
...
\section*{Output} 
	...
	\begin{figure}[h]
		\includegraphics[width=\linewidth]{/Users/shivanandrachewad/Downloads/output1}
		\caption{output1}
		\label{output}
	\end{figure}
    \begin{figure}[h]
	    \includegraphics[width=\linewidth]{/Users/shivanandrachewad/Downloads/output2}
	    \caption{output2}
	    \label{output}
    \end{figure}
